...
const Sponsors = () => {
  return (
    <div id="sponsors-wrapper">
      <h1 id="sponsors">Sponsors
      </h1>
      <p id="sponsor-us">Interested in sponsoring us? Email us at&nbsp;
        <span>
          <a id="email" href="mailto:tritonhacks@gmail.com">tritonhacks@gmail.com</a>
        </span>.
      </p>
      ...
      <div id="partner-images">
        ...
        <img src={ieee} alt="Institute of Electrical and Electronics Engineers"></img>
